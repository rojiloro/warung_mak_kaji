...
<head>
  ...
  <title>Login - Warung Mak Kaji</title>
...
<body class="bg-[#F6F7F2] font-sans antialiased">
  ...
  <div class="min-h-[calc(100vh-73px)] flex items-center justify-center p-4">
    <div class="bg-white rounded-3xl shadow-lg w-full max-w-7xl overflow-hidden flex flex-col md:flex-row">
      ...
      <div class="md:w-3/5 bg-[#DDE8CF] p-8 flex flex-col justify-center">
        <h1 class="text-5xl font-bold text-gray-900">
          Warung Mak Kaji
        </h1>
        <p class="mt-4 text-lg text-gray-700 leading-relaxed">
          Sistem kasir dan manajemen warung
        </p>
      </div>
        ...
        <form method="POST" action="{{ route('login') }}">
          ...
          <div class="mb-4">
            ...
            <x-text-input 
              ...
              name="email" 
              type="email" 
              class="w-full rounded-2xl mt-2 border-2 border-[#5E8B4A] focus:border-[#5E8B4A] focus:ring-[#5E8B4A]" 
              :value="old('email')" 
              required 
              autofocus 
            />
